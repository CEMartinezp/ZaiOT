...
texts = {
    "es": {
        ...
        "data_concepts": [
            ...
            "Tarifa horaria regular",
            "Horas trabajadas a tiempo y medio",
            "Horas trabajadas a doble tarifa",
            "Tarifa esperada a tiempo y medio (regular × 1.5)",
            "Tarifa esperada a doble tarifa (regular × 2.0)",
            "Tarifa real ingresada a tiempo y medio",
            "arifa real ingresada a doble tarifa",
            "Calculado (horas × tarifa)",
            "Total ingresado manualmente (recibo/W-2)"
        ],
    ...
    "en": {
        ...
        "data_concepts": [
            ...
            "Expected time-and-a-half rate (regular × 1.5)",
            "Expected double-time rate (regular × 2.0)",
            "Actual time-and-a-half rate entered",
            "Actual double-time rate entered",
            "Calculated (hours × rate)",
            "Manually entered total (pay stub/W-2)"
        ],
